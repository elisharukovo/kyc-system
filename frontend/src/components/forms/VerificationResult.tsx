    ...
    <div className="space-y-5">
      ...
      <div className={`rounded-2xl p-8 text-center ${
        ...
        <h2 className={`text-xl font-bold mb-2 ${
          ...
          {isVerified ? 'Verified' : isRejected ? 'Rejected' : 'Processing'}
        </h2>
        ...
        <p className={`text-sm max-w-sm mx-auto leading-relaxed ${
          ...
          {isVerified
            ? 'Your KYC verification is complete. A loan officer will contact you within 2 to 3 business days.'
            : isRejected
              ...
              <div key={i} className={`rounded-lg p-3 text-xs ${
                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className={`pill ${
                    ...
                    {step ? (step.status === 'PASSED' ? 'Verified' : 'Rejected') : 'Pending'}
                  </span>
                </div>
